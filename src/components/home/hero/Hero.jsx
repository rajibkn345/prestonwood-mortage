      ...
      <section className='hero'>
        <div className='flexLeft'>
          <div className="hero-item">
            ...
            >
            <div>
              <TextField onChange={inputChangeHandler} label="Total Amount" id="outlined-number" type="number" InputLabelProps={{shrink: true }} name='totalAmount' value={totalAmount} placeholder="$30,000" />
              <TextField onChange={inputChangeHandler} label="Down Payment" id="outlined-number" type="number" InputLabelProps={{shrink: true }} name="downPayment" value={downPayment} placeholder="$6,000" />
            </div>
            <div>
              <TextField onChange={inputChangeHandler} label="Interest Rate" id="outlined-number" type="number" InputLabelProps={{shrink: true }} name="interest" value={interest} placeholder="4%" />
              <TextField onChange={inputChangeHandler} label="Mortage Period" id="outlined-number" type="number" InputLabelProps={{shrink: true }} name="period" value={period} placeholder="30" />
            </div>
